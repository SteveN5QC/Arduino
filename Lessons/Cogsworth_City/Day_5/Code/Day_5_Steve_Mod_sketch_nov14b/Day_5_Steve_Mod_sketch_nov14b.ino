...
void loop() {
  ...
  if (switchState1 != lastSwitchState1)  {
    if (switchState1 == HIGH)  {
      ledState1 = !ledState1;  // Toggle LED state -- Corrected ledState1 == !ledState1 to ledState1 = !ledState1.
  ...
  if (switchState3 != lastSwitchState3)  {
    if (switchState3 == HIGH)  {
      ledState2 = !ledState2;  // Toggle LED state -- Corrected ledState2 == !ledState2 to ledState2 = !ledState2.
