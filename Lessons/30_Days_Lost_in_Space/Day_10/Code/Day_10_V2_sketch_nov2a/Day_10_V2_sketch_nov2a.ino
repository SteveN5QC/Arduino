...
void signalFellLeft() {
    signalMorse("... --- ...   .-.. .-.. .-..", bluePin); // "SOS LLL" in blue
}

void signalFellRight() {
    signalMorse("... --- ...   .-. .-. .-.", bluePin); // "SOS RRR" in blue
}
...
void signalSuccess() {
    signalMorse("... .... .- ...- .   .- -. -..   .-   .... .- .. .-. -.-. ..- -   ..-. --- .-.", greenPin); // "shave and a haircut 2 bits" in green
}

// Morse code helper with color parameter
void signalMorse(String morse, int colorPin) {
    ...
    setColor(0); // Turn off LED after signaling
}
